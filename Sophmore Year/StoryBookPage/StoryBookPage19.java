...
public class StoryBookPage19 extends JPanel
{
  ...
  public StoryBookPage19()
  {
    ...
    // This is the method that sets the background for the StoryBookPage19.
    ...
    JLabel potatoPudell = new JLabel(imageDisplay("potatoPudell.png", 1000, 600));
    JLabel maaPudell = new JLabel(imageDisplay("maaPudell.png", 100, 100));
    JLabel medPudell = new JLabel(imageDisplay("medPudell.png", 100, 100));
    JLabel megPudell = new JLabel(imageDisplay("megPudell.png", 100, 100));
    JLabel mzonPudell = new JLabel(imageDisplay("mzonPudell.png", 100, 100));
    // This method sets the position (first two numbers) and size (last two numbers)
    // of the JLabel in the StoryBookPage.
    potatoPudell.setBounds(0, 0, 1000, 600);
    maaPudell.setBounds(400,300,100,100);
    medPudell.setBounds(600,300,100,100);
    megPudell.setBounds(800,300,100,100);
    mzonPudell.setBounds(200,300,200,200);
    ...
    text.setBounds(10, 400, 200, 100);
        // This line adds your created JLabel to the StoryBookPage19
    add(maaPudell);
    add(medPudell);
    add(megPudell);
    add(mzonPudell);
  ...
  public static void main(String[] args)
  {
    ...
    StoryBookPage19 page = new StoryBookPage19();
